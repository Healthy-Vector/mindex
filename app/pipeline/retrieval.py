...
#: **어휘 단독으로 @5 556건을 다 맞힌다.** 의미검색이 기여할 여지 자체가 없어
#: 가중치를 어떻게 줘도 같은 결과가 나온다.
#:
#: 아래는 무상 패턴 수정(dac2ee1) 이후 2026-08-25 재측정치다.
#:
#:                    원본 @1 / @5      held-out @1 / @3 / @5
#:   어휘 단독        85.8% / 100.0%    68.0% / 80.0% / 80.0%
#:   의미 단독        44.6% /  96.9%    41.2% / 81.1% / 95.9%
#:   w=0.3            —                 76.8% / 95.7% / 99.8%
#:   w=0.5            89.0% / 100.0%    77.5% / 96.8% / 99.8%   <- 채택
#:   w=0.7            —                 75.0% / 96.2% / 99.8%
#:   RRF k=60         80.4% /  99.8%    59.5% / 88.1% / 89.9%   (수정 전 측정)
#:
